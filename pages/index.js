    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-50">
      <main className="flex flex-col items-center justify-center w-full flex-1 px-4 sm:px-20 text-center">
        <h1 className="text-4xl font-bold mb-6">
          Hey there! Meet <span className="text-blue-600"> Jarvis</span>
        </h1>
        
        <p className="text-lg mb-8">
          Your AI companion ready to jumpstart your project - Select a bot to begin chatting
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full">
          <Link href="/bot1" className="group">
            <div className="border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-md transition-all duration-200 flex flex-col items-center">
              ...
              <h2 className="text-xl font-semibold">Discover if Jacob is the dream partner for your next big project</h2>
              <p className="text-gray-600 mt-2">Ask what he can do.</p>
            </div>
          </Link>
          ...
          <Link href="/bot2" className="group">
            <div className="border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-md transition-all duration-200 flex flex-col items-center">
              ...
              <p className="text-gray-600 mt-2">Ask about the EU AI Act and does it affect your AI idea?</p>
            </div>
          </Link>
        </div>
